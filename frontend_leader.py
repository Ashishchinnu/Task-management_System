#this is the streamlit code for leader we will have to place the url of the leader node and all the CRUD operations will be performed by the leader node which can be seen looking at the output on the leader terminal 
...
leader_url = st.text_input("Leader Node URL", "http://127.0.1.1:5031/fromLeader")
